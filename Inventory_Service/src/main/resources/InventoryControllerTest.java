...
class InventoryControllerTest {
    ...
    void testGetValueSaveIn_Exception() {
        ...
        assertThrows(RuntimeException.class, () -> {controller.getValueSaveIn(mockinventory1);
        });
    }
    ...
    void testGetInventoryById_Exception() {
        ...
        assertThrows(RuntimeException.class, () -> {controller.getInventoryById(101L);
        });
    }
    ...
    void testGetAllInventoryId_Exception() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> {controller.getAllinventoryId();
        });
    ...
    void testUpdateInventoryById_Exception() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> {controller.updateInventoryById(101L, mockinventory1);
        });
    ...
    void testDelInventory_Exception() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> {controller.delInventory(101L);
        });
    ...
    void testFindByProductName_Exception() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> {controller.findByProductNameStartingWithIgnoringCase("Laptop");
        });
    ...
    void testWentOutOfStock_ExceptionThrown() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> {controller.wentOutOfStock(101L);
        });
